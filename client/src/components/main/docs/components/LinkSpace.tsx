...
import { convertStrToNode } from "./RenderTag";
...
export const LinkSpace: React.FC<ILinkSpace> = ({
	children,
	className,
	...props
}) => {
	...
	return (
		<div className={`${className ?? "linkSpace"}`} {...props}>
			...
			>
				<IconCopy />
				<span
					className={`${className ?? "linkSpace"}__tooltip 
